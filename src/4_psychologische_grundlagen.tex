...
% reziproker Altruismus: Kooperation/Mitfühlen mit Nicht-Verwandten (Menschen/Spezies)
% altruistisches Verhalten gegenüber Menschen, die man kennt oder sich identifizieren kann (Spiegel) – nicht so bei anonymen Fremden. Vertrauen ist ähnlichen Menschen gegenüber größer – auch vertraute Situation ist förderlich
% wachsende Gruppengröße erschwert Täuschungsversuche zu erkennen
% Dunbar-Zahl (150)
% angeborenes Bedürfnis nach Vertrauen
%	Vertruaen seit vielen Generatoinen fester Bestandteil


\subsubsection{Druckmechanismen}\label{sec:druckmechanismen}
% Warum wir davon ausgehen, dass andere uns nicht betrügen
% Zweck der Druckmechanismen
% Beispiele (2 oder 3) -> Gesellschaftlich, Sicherheitssysteme

% Sicherhheitssysteme
%	Türcshlösser, Alarmanlagen
%	Verteidigungssysteme: Antivirus-SW
%	Interventionen: Uniformen (Angriffspotenzial)
%	Prävention: provisorische Polizeipräsenz
%	Meldesysteme
%	

%	schwindender Sicherheitszuwachst (beschränkt vs. linear)
%	stellen zudem großes Potenzial zur Täsuchung dar!

% Druckmechanismen sind kein Schutz, sondern dienen vielmehr der Schadensreduzierung
\subsubsection{Abweichler vom System}
